...
namespace Project.ENTITIES.Models
{
    public class Fair : BaseEntity
    {
        ...
        public virtual Customer Customer { get; set; } // 1 Fair 1 Customer, 1 Customer N Fair
        public virtual Building Building { get; set; } // 1 Fair 1 Building, 1 Building N Fair
        public virtual List<FairService> FairServices { get; set; } // 1 Fair N FairService, 1 FairService 1 Fair
        public virtual List<Payment> Payments { get; set; } // 1 Fair N Payment, 1 Payment 1 Fair
        public virtual List<FairEmployee> Employees { get; set; } // 1 Fair N Employee, 1 Employee N Fair (Ara tablo : FairEmployee)
        public virtual List<FairDelay> FairDelays { get; set; } // 1 Fair N FairDelay, 1 FairDelay 1 Fair
