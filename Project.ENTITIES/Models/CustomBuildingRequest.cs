...
namespace Project.ENTITIES.Models
{
    public class CustomBuildingRequest : BaseEntity
    {
        ...
        public virtual Customer Customer { get; set; } // 1 CustomBuildingRequest 1 Customer, 1 Customer N CustomBuildingRequest
        public virtual Location Location { get; set; } // 1 CustomBuildingRequest 1 Location, 1 Location N CustomBuildingRequest
    }
}
