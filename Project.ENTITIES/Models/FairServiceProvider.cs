...
namespace Project.ENTITIES.Models
{
    public class FairServiceProvider : BaseEntity
    {
        ...
        public virtual FairService FairService { get; set; } // 1 FairService N ServiceProvider, 1 ServiceProvider N FairService
        public virtual ServiceProvider ServiceProvider { get; set; } // 1 ServiceProvider N FairService, 1 FairService N ServiceProvider
    }
}
