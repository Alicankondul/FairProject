...
namespace Project.ENTITIES.Models
{
    public class ServiceValue : BaseEntity
    {
        ...
        public virtual ServiceDescriptor ServiceDescriptor { get; set; } // 1 ServiceValue 1 ServiceDescriptor, 1 ServiceDescriptor N ServiceValue
        //public virtual List<ServiceProvider> Providers { get; set; } // 1 ServiceValue N ServiceProvider, 1 ServiceProvider 1 ServiceValue
