...
namespace Project.WinFormUI.Forms.CustomerForms
{
    public partial class FairPriceOfferForm : Form
    {
        ...
        private void FairPriceOfferForm_Load(object sender, EventArgs e)
        {
            ...
            label3.Visible = false; //Ek etiket.
        }
        ...
        private void BtnAcceptOffer_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Fair newFair = new Fair
                {
                    ...
                    BuildingId = SelectedBuilding.Id, //Seçilen binanun ID'si.
                ...
                MessageBox.Show("Teklif kabul edildi ve fuar oluşturuldu! Ödeme ekranına yönlendiriliyorsunuz.", "Başarılı", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void BtnGonder_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Girdiğiniz fiyat, önerilen fiyatın üzerinde olamaz. Lütfen daha düşük bir fiyat giriniz.", "Geçersiz Teklif", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
            ...
            DialogResult result = MessageBox.Show($"Yeni teklif sunuldu: {finalOffer:C2}\nOnaylıyor musunuz?", "Yeni Teklif", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
        ...
        private int CalculatePreparationDays()
        {
            ...
            if (SelectedServices != null && SelectedServices.Any())
            {
                ...
                {
                    //Burada hizmetlerin hazırlık sürelerini almanız gerekecek. Örneğin ; ServiceValueRepository'den süreleri alarak ekleme yapabilirsiniz.
