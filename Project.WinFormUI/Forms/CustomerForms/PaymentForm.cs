...
namespace Project.WinFormUI.Forms.CustomerForms
{
    public partial class PaymentForm : Form
    {
        ...
        private void BtnPay_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Fuar bilgisi eksik veya hatalı. Ödeme işlemi gerçekleştirilemez.", "Hata", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
            ...
            Payment payment = new Payment
            {
                ...
                PaymentStatus = PaymentStatus.Paid, //Başlangıç başarılı olarak işaretleniyor
